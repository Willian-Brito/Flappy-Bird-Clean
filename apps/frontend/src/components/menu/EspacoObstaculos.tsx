import { EspacoObstaculo as Espaco } from "core";
...
export default function EspacoObstaculos() {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex">
                <Botao
                    cor={jogo.espaco === Espaco.MAIOR ? "bg-red-500" : "bg-zinc-400"}
                    semBordaDireita
                ...
                <Botao
                    cor={jogo.espaco === Espaco.NORMAL ? "bg-red-500" : "bg-zinc-500"}
                    semBorda
                ...
                <Botao
                    cor={jogo.espaco === Espaco.MENOR ? "bg-red-500" : "bg-zinc-600"}
                    semBordaEsquerda
